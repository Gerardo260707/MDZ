(function () {
  const DICT = {
    es: {
      ...
      btn_customize: 'Personalizar', custom_title: 'Personalizar Diseño', custom_step1: '1. Selecciona un color.', custom_step2: '',
    ...
    en: {
      ...
      btn_customize: 'Customize', custom_title: 'Customize Design', custom_step1: '1. Select a color.', custom_step2: '',
      ...
      custom_model_search_input: 'Type model name', custom_select_center: 'Select center', custom_select_cenefa: 'Select border', custom_select_esquina: 'Select corner', colors_title: 'Color palette', colors_desc: 'Browse all available colors for customization.', custom_step_area: '', custom_undo: 'Undo color', custom_redo: 'Redo color', custom_home: 'Original image',
