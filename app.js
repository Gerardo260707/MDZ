(function () {
  const DICT = {
    ...
    en: {
      ...
      contact_title: 'Contact', lang_label: 'Language', quote_toggle: 'Request a quote', compare_preview_title: 'Comparison preview', compare_models_toggle: 'Compare models', compare_models_count_label: 'Models to compare', compare_mode_enabled_notice: 'Compare mode is on: select 2 models or more to view them side by side, or press the button again to exit.', contact_intro: 'Visit our showrooms, or call us for more information. You can contact us here.', contact_location_title: 'Location', contact_showroom_title: 'Sales and Showroom', contact_factory_title: 'Factory', contact_address_label: 'Address'
    }
  };
